...
% Title Information
\title[Apache Hive Seminar]{\textbf{Apache Hive: A Petabyte-Scale Data Warehouse System }\\\textbf{Over a MapReduce Framework}}
...
%==============================================================================
\begin{frame}{Apache Hive \& Query Optimization}
    \begin{columns}[T]
        \column{0.5\textwidth}
...
\begin{frame}{Query Performance Benchmarks}
    \begin{columns}[T]
        ...
        \begin{alertblock}{Join Algorithm Comparison}
            \begin{itemize}
                \item Map-Side: \textbf{15.30s} (2.8x faster)
                \item Reduce-Side: 42.70s (baseline)
            \end{itemize}
        \end{alertblock}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Achievements}
            \begin{itemize}
                ...
                \begin{itemize}
                    \item 2.8x speedup with Map-Side joins
